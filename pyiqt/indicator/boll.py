...
class BollWrap:
    def __init__(self, symbol, frequency):
        ...
        SinaDataSource().getTick("cu1707", callback)
        SinaDataSource().getTick("cu1708", callback)

        BarBuilderFactory().create(symbol=symbol, frequency=frequency)
        self.observer = BarObserver(self)
        BarSubject().attach(symbol + ":" + frequency, self.observer)
